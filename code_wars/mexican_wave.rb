...
# able to travel continuously around the arena; in discontiguous seating arrangements, the
# wave can instead reflect back and forth through the crowd. When the gap in seating is
# narrow, the wave can sometimes pass through it. Usually only one wave crest will be present
# at any given time in an arena, although simultaneous, counter-rotating waves have been
